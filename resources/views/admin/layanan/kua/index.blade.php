...
<div class="row">
  <div class="col-md-12 fw-bold fs-3">Kelola Layanan KUA</div>
  <hr class="mb-4">
</div>
{{-- Header Menu --}}
<div class="row justify-content-between mb-4">
  <div class="col-6">
    <a name="" id="" class="btn btn-primary" href="/admin/layanan/kua/create" role="button"><i class="bi bi-plus"></i>
      Tambah Layanan Baru</a>
  </div>
  <div class="col-4">
    <form action="/admin/layanan/kua" method="get">
...
<table class="table table-striped table-inverse table-responsive">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        {{-- Update --}}
        <a name="" id="" class="btn btn-warning" href="/admin/layanan/kua/{{ $post->slug }}/edit" role="button">
...
@push('deleteLayananKUA')
<script>
  $(document).on('click','.delete',function(){
         let id = $(this).attr('data-id');
         let title = $(this).attr('data-title');
         $('#id').val(id);
         $('#delModalForm').attr('action','/admin/layanan/kua/' + id);
