...
<div class="row text-center">
  <div class="col-md-12 fw-bold fs-3">Perbarui Layanan Haji</div>
  <hr class="mb-4">
</div>
<div class="container">
  <div class="row border shadow mx-5 px-5" style="background-color: whitesmoke">
    <div class="col-12 py-3">
      <form action="/admin/layanan/haji/{{ $post->slug }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <a name="batal" id="batal" class="btn btn-secondary px-4" href="/admin/layanan/haji" role="button">Batal</a>
