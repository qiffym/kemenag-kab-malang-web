...
<div class="row text-center">
  <div class="col-md-12 fw-bold fs-3">Tulis Layanan Pendidikan</div>
  <hr class="mb-4">
</div>
<div class="container">
  <div class="row border shadow mx-5 px-5" style="background-color: whitesmoke">
    <div class="col-12 py-3">
      <form action="/admin/layanan/pendidikan/{{ $post->slug }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        {{-- Kategori --}}
        <div class="mb-3">
          ...
          <select name="kategori" class="form-select @error('kategori') is-invalid @enderror"
            ...
            <option selected value="{{ $post->layanan_category_id }}">{{ $post->layanan_category->name }}</option>
        ...
        <a name="batal" id="batal" class="btn btn-secondary px-4" href="/admin/layanan/pendidikan"
          role="button">Batal</a>
