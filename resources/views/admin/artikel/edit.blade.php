...
<div class="container">
  <div class="row border shadow mx-5 px-5" style="background-color: whitesmoke">
    <div class="col-12 py-3">
      <form action="/admin/artikel/{{ $post->slug }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        {{-- Judul --}}
        <div class="mb-3">
        ...
        <hr>
        <a name="batal" id="batal" class="btn btn-secondary px-5" href="/admin/artikel" role="button">Batal</a>
