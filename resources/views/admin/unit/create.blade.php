...
<div class="row text-center">
  <div class="col-md-12 fw-bold fs-3">Tulis Berita Satker</div>
  <hr class="mb-4">
</div>
<div class="container">
  <div class="row border shadow mx-5 px-5" style="background-color: whitesmoke">
    <div class="col-12 py-3">
      <form action="/admin/unit" method="post" enctype="multipart/form-data">
        @csrf
        {{-- Penulis --}}
        ...
        <div class="mb-3">
          ...
          <select name="kategori" class="form-select @error('kategori') is-invalid @enderror"
            ...
            <option selected value="{{ old('kategori') }}">-- Pilih Kategori --</option>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('keyword') is-invalid @enderror" name="keyword" id="keyword"
            value="{{ old('keyword') }}" placeholder="contoh: graduation, graduasi, perpisahan" required>
          @error('keyword')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
